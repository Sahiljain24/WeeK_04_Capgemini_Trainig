...
class Policy implements Comparable<Policy> {
    ...
    // Overriding equals() and hashCode() to ensure unique policies based on policyNumber
    @Override
...
public class InsurancePolicyManagement {
    ...
    public void performanceComparison() {
        ...
        for (Policy policy : testPolicies) hashSetPolicies.add(policy);
        long hashSetTime = System.nanoTime() - start;

        start = System.nanoTime();
        for (Policy policy : testPolicies) linkedHashSetPolicies.add(policy);
        long linkedHashSetTime = System.nanoTime() - start;

        start = System.nanoTime();
        for (Policy policy : testPolicies) treeSetPolicies.add(policy);
        long treeSetTime = System.nanoTime() - start;

        System.out.println("Insertion Time (ns): HashSet=" + hashSetTime + ", LinkedHashSet=" + linkedHashSetTime + ", TreeSet=" + treeSetTime);
        ...
        System.out.println("Search Time (ns): HashSet=" + hashSetSearchTime + ", LinkedHashSet=" + linkedHashSetSearchTime + ", TreeSet=" + treeSetSearchTime);
    }
